...
// VExtensions
#define COCOAPODS_POD_AVAILABLE_VExtensions
#define COCOAPODS_VERSION_MAJOR_VExtensions 1
#define COCOAPODS_VERSION_MINOR_VExtensions 0
#define COCOAPODS_VERSION_PATCH_VExtensions 9

// VPickImage
#define COCOAPODS_POD_AVAILABLE_VPickImage
#define COCOAPODS_VERSION_MAJOR_VPickImage 1
#define COCOAPODS_VERSION_MINOR_VPickImage 0
#define COCOAPODS_VERSION_PATCH_VPickImage 0

// VSVProgressHUD
#define COCOAPODS_POD_AVAILABLE_VSVProgressHUD
#define COCOAPODS_VERSION_MAJOR_VSVProgressHUD 1
#define COCOAPODS_VERSION_MINOR_VSVProgressHUD 0
#define COCOAPODS_VERSION_PATCH_VSVProgressHUD 0
